...
class HaskimailClient extends HaskimailClientBase {
	 ...
	 */
	function getServer() {
		return new DynamicResponseModel($this->processRestRequest('GET', '/servers'));
	}
	...
	function getOutboundOverviewStatistics($tag = NULL, $fromdate = NULL, $todate = NULL, $messagestream = NULL) {
		...
		return new DynamicResponseModel($this->processRestRequest('GET', '/stats', $query));
	}
	...
	function getOutboundSendStatistics($tag = NULL, $fromdate = NULL, $todate = NULL, $messagestream = NULL) {
		...
		return new DynamicResponseModel($this->processRestRequest('GET', '/stats/sends', $query));
	}
	...
	function getOutboundBounceStatistics($tag = NULL, $fromdate = NULL, $todate = NULL, $messagestream = NULL) {
		...
		return new DynamicResponseModel($this->processRestRequest('GET', '/stats/bounces', $query));
	}
	...
	function getOutboundSpamComplaintStatistics($tag = NULL, $fromdate = NULL, $todate = NULL, $messagestream = NULL) {
		...
		return new DynamicResponseModel($this->processRestRequest('GET', '/stats/spam', $query));
	}
	...
	function getOutboundTrackedStatistics($tag = NULL, $fromdate = NULL, $todate = NULL, $messagestream = NULL) {
		...
		return new DynamicResponseModel($this->processRestRequest('GET', '/stats/tracked', $query));
	}
	...
	function getOutboundOpenStatistics($tag = NULL, $fromdate = NULL, $todate = NULL, $messagestream = NULL) {
		...
		return new DynamicResponseModel($this->processRestRequest('GET', '/stats/opens', $query));
	}
	...
	function getOutboundPlatformStatistics($tag = NULL, $fromdate = NULL, $todate = NULL, $messagestream = NULL) {
		...
		return new DynamicResponseModel($this->processRestRequest('GET', '/stats/opens/platforms', $query));
	}
	...
	function getOutboundEmailClientStatistics($tag = NULL, $fromdate = NULL, $todate = NULL, $messagestream = NULL) {
		...
		return new DynamicResponseModel($this->processRestRequest('GET', '/stats/opens/emailclients', $query));
	}
	...
	function getOutboundReadTimeStatistics($tag = NULL, $fromdate = NULL, $todate = NULL) {
		...
		return new DynamicResponseModel($this->processRestRequest('GET', '/stats/opens/readtimes', $query));
	}
	...
	function getOutboundClickStatistics($tag = NULL, $fromdate = NULL, $todate = NULL, $messagestream = NULL) {
		...
		return new DynamicResponseModel($this->processRestRequest('GET', '/stats/clicks', $query));
	}
	...
	function getOutboundClickBrowserFamilyStatistics($tag = NULL, $fromdate = NULL, $todate = NULL, $messagestream = NULL) {
		...
		return new DynamicResponseModel($this->processRestRequest('GET', '/stats/clicks/browserfamilies', $query));
	}
	...
	function getOutboundClickBrowserPlatformStatistics($tag = NULL, $fromdate = NULL, $todate = NULL, $messagestream = NULL) {
		...
		return new DynamicResponseModel($this->processRestRequest('GET', '/stats/clicks/platforms', $query));
	}
	...
	function getOutboundClickLocationStatistics($tag = NULL, $fromdate = NULL, $todate = NULL, $messagestream = NULL) {
		...
		return new DynamicResponseModel($this->processRestRequest('GET', '/stats/clicks/location', $query));
	}
